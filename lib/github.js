...
async function createMentorIssue(config, data) {
  ...
  const mentorIssueTemplate = fs.readFileSync(path.resolve(config.TEMPLATES_PATH, config.MENTOR_ISSUE_TEMPLATE), 'utf8');
